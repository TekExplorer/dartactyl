...
Relationships _$RelationshipsFromJson(Map<String, dynamic> json) {
  return Relationships(
    ...
    egg: json['egg'] == null
        ? null
        : FractalResponseData.fromJson(json['egg'] as Map<String, dynamic>,
            (value) => Egg.fromJson(value as Map<String, dynamic>)),
    subusers: json['subusers'] == null
        ? null
        : FractalResponseList.fromJson(json['subusers'] as Map<String, dynamic>,
