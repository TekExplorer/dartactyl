...
import 'package:dartactyl/src/websocket_legacy/_internal.dart';
import 'package:dartactyl/src/websocket_legacy/models/connection_state.dart';
import 'package:dartactyl/src/websocket_legacy/models/websocket_log.dart';
import 'package:dartactyl/src/websocket_legacy/models/websocket_stats.dart';
  ...
  Future<void> _onData(Object? data) async {
    ...
    switch (receiveEvent) {
      ...
      case ServerWebsocketReceiveEvent.status:
        ...
        final powerState = ServerPowerState.maybeParse(arg);
        if (powerState == null) {
          throw UnknownWingsEventException._arg(
